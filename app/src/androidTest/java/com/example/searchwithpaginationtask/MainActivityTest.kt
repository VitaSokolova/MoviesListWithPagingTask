...
import com.example.searchwithpaginationtask.presentation.views.PRODUCTS_LIST_TEST_TAG
import com.example.searchwithpaginationtask.presentation.views.PRODUCT_TEST_TAG
...
class MainActivityTest {
    ...
    fun whenSearchIsPerformedShouldShowResults() {
        with(composeRule) {
            ...
            onNodeWithTag(PRODUCTS_LIST_TEST_TAG)
                .onChildren()
                .filter(hasTestTag(PRODUCT_TEST_TAG))
